	...
	Callback = function()
		if checkKey(userKey) then
			...
			task.delay(2, function()
				Window:Destroy()
				loadstring(game:HttpGet("https://raw.githubusercontent.com/anhlamgixungdangvoiem/mainpremium/refs/heads/main/pre.lua"))() 
			end)
		end
	end,
})
